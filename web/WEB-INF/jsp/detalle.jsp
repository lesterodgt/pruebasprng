                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="product-entry">
                                            <div class="product-img" style="background-image: url(../resources/images/item-${producto.idproducto}.jpg);">
                                        ...
                                        <div id="review" class="tab-pane fade">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h3>23 Reviews</h3>
                                                    <div class="review">
                                                        <div class="user-img" style="background-image: url(../resources/images/person1.jpg)"></div>
                                                        <div class="desc">
                                                            <h4>
                                                    ...
                                                    <div class="review">
                                                        <div class="user-img" style="background-image: url(../resources/images/person2.jpg)"></div>
                                                        <div class="desc">
                                                            <h4>
                                                                <span class="text-left">Jacob Webb</span>
                                                                <span class="text-right">14 March 2018</span>
                                                    ...
                                                    <div class="review">
                                                        <div class="user-img" style="background-image: url(../resources/images/person3.jpg)"></div>
                                                        <div class="desc">
                                                            <h4>
                                                                <span class="text-left">Jacob Webb</span>
                                                                <span class="text-right">14 March 2018</span>
